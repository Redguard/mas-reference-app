...
//            ComponentName(
//                "org.masreferenceapp",
//                "org.masreferenceapp.platform.helpers.UINotification"
//            )
//        )
//
//        context.applicationContext.startActivity(myIntent)
    ...
    fun prohibitScreenshot(): String {
        ...
        myIntent.setComponent(
            ComponentName(
                "org.masreferenceapp",
                "org.masreferenceapp.platform.helpers.UIProhibitScreenshot"
            )
        )
    ...
    fun passwordPlaintextUi(): String {
        ...
        myIntent.setComponent(
            ComponentName(
                "org.masreferenceapp",
                "org.masreferenceapp.platform.helpers.UIPlainTextPassword"
            )
        )
