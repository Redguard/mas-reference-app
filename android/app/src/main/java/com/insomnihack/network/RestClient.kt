...
class RestClient {
     ...
     */
    fun sendFeedback(name: String, feedback: String, secretKey: String, onSuccess: (String) -> Unit, onFailure: (IOException) -> Unit) {

        val url = "$baseUrl/authorise" // Replace with your actual API endpoint
